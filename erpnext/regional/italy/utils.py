...
from VantageSuite.controllers.taxes_and_totals import get_itemised_tax
from VantageSuite.regional.italy import state_codes
...
def prepare_and_attach_invoice(doc, replace=False):
	...
	invoice_xml = frappe.render_template(
		"VantageSuite/regional/italy/e-invoice.xml",
