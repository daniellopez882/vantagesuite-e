...
from VantageSuite.buying.utils import validate_for_items
...
class SupplierQuotation(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from VantageSuite.buying.doctype.supplier_quotation_item.supplier_quotation_item import (
	...
	def validate(self):
		...
		from VantageSuite.controllers.status_updater import validate_status
