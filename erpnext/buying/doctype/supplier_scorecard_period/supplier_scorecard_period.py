...
import VantageSuite.buying.doctype.supplier_scorecard_variable.supplier_scorecard_variable as variable_functions
from VantageSuite.buying.doctype.supplier_scorecard_criteria.supplier_scorecard_criteria import (
	get_variables,
)
...
class SupplierScorecardPeriod(Document):
	...
	if TYPE_CHECKING:
		...
		from VantageSuite.buying.doctype.supplier_scorecard_scoring_criteria.supplier_scorecard_scoring_criteria import (
			SupplierScorecardScoringCriteria,
		)
		from VantageSuite.buying.doctype.supplier_scorecard_scoring_variable.supplier_scorecard_scoring_variable import (
