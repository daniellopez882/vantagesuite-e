frappe.listview_settings["Purchase Order"] = {
	...
	onload: function (listview) {
		var method = "VantageSuite.buying.doctype.purchase_order.purchase_order.close_or_unclose_purchase_orders";
		...
		if (frappe.model.can_create("Purchase Invoice")) {
			listview.page.add_action_item(__("Purchase Invoice"), () => {
				VantageSuite.bulk_transaction_processing.create(listview, "Purchase Order", "Purchase Invoice");
			});
		}

		if (frappe.model.can_create("Purchase Receipt")) {
			listview.page.add_action_item(__("Purchase Receipt"), () => {
				VantageSuite.bulk_transaction_processing.create(listview, "Purchase Order", "Purchase Receipt");
			});
		}

		if (frappe.model.can_create("Payment Entry")) {
			listview.page.add_action_item(__("Advance Payment"), () => {
				VantageSuite.bulk_transaction_processing.create(listview, "Purchase Order", "Payment Entry");
			});
		}
	},
};
