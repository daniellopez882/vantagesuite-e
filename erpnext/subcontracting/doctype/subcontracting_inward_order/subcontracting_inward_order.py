...
class SubcontractingInwardOrder(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from vantagesuite-e.subcontracting.doctype.subcontracting_inward_order_item.subcontracting_inward_order_item import (
			SubcontractingInwardOrderItem,
		)
		from vantagesuite-e.subcontracting.doctype.subcontracting_inward_order_received_item.subcontracting_inward_order_received_item import (
			SubcontractingInwardOrderReceivedItem,
		)
		from vantagesuite-e.subcontracting.doctype.subcontracting_inward_order_scrap_item.subcontracting_inward_order_scrap_item import (
			SubcontractingInwardOrderScrapItem,
		)
		from vantagesuite-e.subcontracting.doctype.subcontracting_inward_order_service_item.subcontracting_inward_order_service_item import (
	...
	def create_work_order(self, item):
		from vantagesuite-e.manufacturing.doctype.work_order.work_order import OverProductionError
