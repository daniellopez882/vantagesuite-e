...
frappe.ui.form.on("Subcontracting Inward Order", {
	...
	sales_order: (frm) => {
		...
		if (frm.doc.sales_order) {
			vantagesuite-e.utils.map_current_doc({
				method: "vantagesuite-e.selling.doctype.sales_order.sales_order.make_subcontracting_inward_order",
	...
	update_subcontracting_inward_order_status(frm, status) {
		frappe.call({
			method: "vantagesuite-e.subcontracting.doctype.subcontracting_inward_order.subcontracting_inward_order.update_subcontracting_inward_order_status",
			args: {
				scio: frm.doc.name,
				status: status,
			},
