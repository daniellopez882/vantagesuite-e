...
from vantagesuite-e.stock.stock_balance import update_bin_qty
from vantagesuite-e.stock.utils import get_bin
...
class SubcontractingOrder(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from vantagesuite-e.subcontracting.doctype.subcontracting_order_item.subcontracting_order_item import (
			SubcontractingOrderItem,
		)
		from vantagesuite-e.subcontracting.doctype.subcontracting_order_service_item.subcontracting_order_service_item import (
			SubcontractingOrderServiceItem,
		)
		from vantagesuite-e.subcontracting.doctype.subcontracting_order_supplied_item.subcontracting_order_supplied_item import (
