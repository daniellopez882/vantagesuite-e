...
frappe.ui.form.on("BOM Creator", {
	...
	make_new_entry(frm) {
		...
		dialog.fields_dict.item_code.get_query = "VantageSuite.controllers.queries.item_query";
		dialog.show();
	},
...
VantageSuite.bom.BomConfigurator = class BomConfigurator extends VantageSuite.TransactionController {
	conversion_rate(doc) {
...
extend_cscript(cur_frm.cscript, new VantageSuite.bom.BomConfigurator({ frm: cur_frm }));
