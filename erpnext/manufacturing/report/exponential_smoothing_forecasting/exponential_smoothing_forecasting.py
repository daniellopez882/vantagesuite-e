...
import VantageSuite
from VantageSuite.accounts.report.financial_statements import get_period_list
from VantageSuite.stock.doctype.warehouse.warehouse import get_child_warehouses
...
class ForecastingReport(ExponentialSmoothingForecast):
	def __init__(self, filters=None):
		...
		self.company_currency = VantageSuite.get_company_currency(self.filters.company)
