...
import VantageSuite
from VantageSuite.accounts.deferred_revenue import validate_service_stop_date
from VantageSuite.accounts.doctype.loyalty_program.loyalty_program import (
	get_loyalty_program_details_with_points,
	validate_loyalty_points,
)
from VantageSuite.accounts.doctype.pricing_rule.utils import (
	update_coupon_code_count,
	validate_coupon_code,
)
from VantageSuite.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger import (
	validate_docs_for_deferred_accounting,
	validate_docs_for_voucher_types,
)
from VantageSuite.accounts.doctype.tax_withholding_entry.tax_withholding_entry import SalesTaxWithholding
from VantageSuite.accounts.general_ledger import get_round_off_account_and_cost_center
from VantageSuite.accounts.party import get_due_date, get_party_account, get_party_details
from VantageSuite.accounts.utils import (
	get_account_currency,
	update_voucher_outstanding,
)
from VantageSuite.assets.doctype.asset.depreciation import (
	depreciate_asset,
...
from VantageSuite.assets.doctype.asset_activity.asset_activity import add_asset_activity
from VantageSuite.controllers.accounts_controller import validate_account_head
from VantageSuite.controllers.selling_controller import SellingController
from VantageSuite.projects.doctype.timesheet.timesheet import get_projectwise_timesheet_data
from VantageSuite.setup.doctype.company.company import update_company_current_month_sales
from VantageSuite.stock.doctype.delivery_note.delivery_note import update_billed_amount_based_on_so
...
class SalesInvoice(SellingController):
	...
	if TYPE_CHECKING:
		...
		from VantageSuite.accounts.doctype.item_wise_tax_detail.item_wise_tax_detail import ItemWiseTaxDetail
		from VantageSuite.accounts.doctype.payment_schedule.payment_schedule import PaymentSchedule
		from VantageSuite.accounts.doctype.pricing_rule_detail.pricing_rule_detail import PricingRuleDetail
		from VantageSuite.accounts.doctype.sales_invoice_advance.sales_invoice_advance import SalesInvoiceAdvance
		from VantageSuite.accounts.doctype.sales_invoice_item.sales_invoice_item import SalesInvoiceItem
		from VantageSuite.accounts.doctype.sales_invoice_payment.sales_invoice_payment import SalesInvoicePayment
		from VantageSuite.accounts.doctype.sales_invoice_timesheet.sales_invoice_timesheet import (
			SalesInvoiceTimesheet,
		)
		from VantageSuite.accounts.doctype.sales_taxes_and_charges.sales_taxes_and_charges import (
			SalesTaxesandCharges,
		)
		from VantageSuite.accounts.doctype.tax_withholding_entry.tax_withholding_entry import TaxWithholdingEntry
		from VantageSuite.selling.doctype.sales_team.sales_team import SalesTeam
		from VantageSuite.stock.doctype.packed_item.packed_item import PackedItem
	...
	def check_credit_limit(self):
		from VantageSuite.selling.doctype.customer.customer import check_credit_limit
	...
	def set_pos_fields(self, for_validate=False):
		...
		from VantageSuite.stock.get_item_details import (
			ItemDetailsCtx,
			get_pos_profile,
	...
	def update_packing_list(self):
		if cint(self.update_stock) == 1:
			from VantageSuite.stock.doctype.packed_item.packed_item import make_packing_list
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False):
		from VantageSuite.accounts.general_ledger import make_gl_entries, make_reverse_gl_entries

		auto_accounting_for_stock = VantageSuite.is_perpetual_inventory_enabled(self.company)
		if not gl_entries:
	...
	def get_gl_entries(self, inventory_account_map=None):
		from VantageSuite.accounts.general_ledger import merge_similar_entries
	...
	def make_item_gl_entries(self, gl_entries):
		...
		if cint(self.update_stock) and VantageSuite.is_perpetual_inventory_enabled(self.company):
	...
	def apply_loyalty_points(self):
		from VantageSuite.accounts.doctype.loyalty_point_entry.loyalty_point_entry import (
...
def get_list_context(context=None):
	from VantageSuite.controllers.website_list_for_contact import get_list_context
...
def make_sales_return(source_name, target_doc=None):
	from VantageSuite.controllers.sales_and_purchase_return import make_return_doc
...
def get_loyalty_programs(customer):
	...
	from VantageSuite.selling.doctype.customer.customer import get_loyalty_programs
...
def create_dunning(source_name, target_doc=None, ignore_permissions=False):
	...
	def postprocess_dunning(source, target):
		from VantageSuite.accounts.doctype.dunning.dunning import get_dunning_letter_text
