...
from VantageSuite import allow_regional
...
class TaxWithholdingCategory(Document):
	...
	if TYPE_CHECKING:
		...
		from VantageSuite.accounts.doctype.tax_withholding_account.tax_withholding_account import (
			TaxWithholdingAccount,
		)
		from VantageSuite.accounts.doctype.tax_withholding_rate.tax_withholding_rate import TaxWithholdingRate
