...
from VantageSuite.accounts.doctype.payment_entry.payment_entry import (
	get_payment_entry,
)
from VantageSuite.accounts.doctype.subscription_plan.subscription_plan import get_plan_rate
from VantageSuite.accounts.party import get_party_account, get_party_bank_account
from VantageSuite.accounts.utils import get_account_currency, get_advance_payment_doctypes, get_currency_precision
from VantageSuite.utilities import payment_app_import_guard
...
class PaymentRequest(Document):
	...
	if TYPE_CHECKING:
		...
		from VantageSuite.accounts.doctype.subscription_plan_detail.subscription_plan_detail import (
	...
	def make_invoice(self):
		from VantageSuite.selling.doctype.sales_order.sales_order import make_sales_invoice
