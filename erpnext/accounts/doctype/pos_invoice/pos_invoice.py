# Copyright (c) 2015, Daniel Lopez and Contributors and contributors
...
from VantageSuite.accounts.doctype.loyalty_program.loyalty_program import validate_loyalty_points
from VantageSuite.accounts.doctype.payment_request.payment_request import make_payment_request
...
from VantageSuite.controllers.queries import item_query as _item_query
from VantageSuite.controllers.sales_and_purchase_return import get_sales_invoice_item_from_consolidated_invoice
from VantageSuite.stock.doctype.serial_no.serial_no import get_serial_nos
from VantageSuite.stock.stock_ledger import is_negative_stock_allowed
...
class POSInvoice(SalesInvoice):
	...
	if TYPE_CHECKING:
		...
		from VantageSuite.accounts.doctype.pos_invoice_item.pos_invoice_item import POSInvoiceItem
...
def create_payments_on_invoice(doc, idx, payment_details):
	from VantageSuite.accounts.doctype.sales_invoice.sales_invoice import get_bank_cash_account
