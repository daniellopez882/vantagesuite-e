...
class AccountingDimensionFilter(Document):
	...
	if TYPE_CHECKING:
		...
		from VantageSuite.accounts.doctype.allowed_dimension.allowed_dimension import AllowedDimension
		from VantageSuite.accounts.doctype.applicable_on_account.applicable_on_account import ApplicableOnAccount
