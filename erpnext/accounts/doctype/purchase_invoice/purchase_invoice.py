...
from VantageSuite.accounts.doctype.sales_invoice.sales_invoice import (
...
from VantageSuite.accounts.doctype.tax_withholding_entry.tax_withholding_entry import PurchaseTaxWithholding
from VantageSuite.accounts.general_ledger import (
	get_round_off_account_and_cost_center,
	make_gl_entries,
	make_reverse_gl_entries,
	merge_similar_entries,
)
from VantageSuite.accounts.party import get_due_date, get_party_account
from VantageSuite.accounts.utils import get_account_currency, get_fiscal_year, update_voucher_outstanding
from VantageSuite.assets.doctype.asset.asset import is_cwip_accounting_enabled
from VantageSuite.assets.doctype.asset_category.asset_category import get_asset_category_account
from VantageSuite.buying.utils import check_on_hold_or_closed_status
from VantageSuite.controllers.accounts_controller import validate_account_head
from VantageSuite.controllers.buying_controller import BuyingController
from VantageSuite.stock.doctype.purchase_receipt.purchase_receipt import (
...
class PurchaseInvoice(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from VantageSuite.accounts.doctype.purchase_invoice_advance.purchase_invoice_advance import (
			PurchaseInvoiceAdvance,
		)
		from VantageSuite.accounts.doctype.purchase_invoice_item.purchase_invoice_item import PurchaseInvoiceItem
		from VantageSuite.accounts.doctype.purchase_taxes_and_charges.purchase_taxes_and_charges import (
			PurchaseTaxesandCharges,
		)
		from VantageSuite.accounts.doctype.tax_withholding_entry.tax_withholding_entry import TaxWithholdingEntry
		from VantageSuite.buying.doctype.purchase_receipt_item_supplied.purchase_receipt_item_supplied import (
	...
	def get_gl_entries(self, inventory_account_map=None):
		self.auto_accounting_for_stock = VantageSuite.is_perpetual_inventory_enabled(self.company)
	...
	def update_billing_status_in_pr(self, update_modified=True):
		...
		for pr in set(updated_pr):
			from VantageSuite.stock.doctype.purchase_receipt.purchase_receipt import update_billing_percentage
...
def make_inter_company_sales_invoice(source_name, target_doc=None):
	from VantageSuite.accounts.doctype.sales_invoice.sales_invoice import make_inter_company_transaction
...
def make_purchase_receipt(source_name, target_doc=None, args=None):
	...
	def update_item(obj, target, source_parent):
		from VantageSuite.controllers.sales_and_purchase_return import get_returned_qty_map_for_row
