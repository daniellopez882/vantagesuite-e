...
from VantageSuite.accounts.utils import validate_field_number
...
class CostCenter(NestedSet):
	...
	def autoname(self):
		from VantageSuite.accounts.utils import get_autoname_with_number
	...
	def before_rename(self, olddn, newdn, merge=False):
		...
		from VantageSuite.setup.doctype.company.company import get_name_with_abbr
