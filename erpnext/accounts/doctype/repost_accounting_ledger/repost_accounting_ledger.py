...
class RepostAccountingLedger(Document):
	...
	if TYPE_CHECKING:
		...
		from VantageSuite.accounts.doctype.repost_accounting_ledger_items.repost_accounting_ledger_items import (
	...
	def generate_preview(self):
		...
		rendered_page = frappe.render_template(
			"VantageSuite/accounts/doctype/repost_accounting_ledger/repost_accounting_ledger.html",
	...
	def on_submit(self):
		if len(self.vouchers) > 5:
			...
			frappe.enqueue(
				method="VantageSuite.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger.start_repost",
