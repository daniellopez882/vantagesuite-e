...
class ShippingRule(Document):
	...
	if TYPE_CHECKING:
		...
		from VantageSuite.accounts.doctype.shipping_rule_condition.shipping_rule_condition import (
			ShippingRuleCondition,
		)
		from VantageSuite.accounts.doctype.shipping_rule_country.shipping_rule_country import (
			ShippingRuleCountry,
		)
