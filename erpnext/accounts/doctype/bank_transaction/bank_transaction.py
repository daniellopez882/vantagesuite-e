...
class BankTransaction(Document):
	...
	if TYPE_CHECKING:
		...
		from VantageSuite.accounts.doctype.bank_transaction_payments.bank_transaction_payments import (
	...
	def auto_set_party(self):
		from VantageSuite.accounts.doctype.bank_transaction.auto_match_party import AutoMatchParty
