...
from VantageSuite.accounts.doctype.pos_invoice_merge_log.pos_invoice_merge_log import (
	consolidate_pos_invoices,
	unconsolidate_pos_invoices,
)
from VantageSuite.controllers.status_updater import StatusUpdater
...
class POSClosingEntry(StatusUpdater):
	...
	if TYPE_CHECKING:
		...
		from VantageSuite.accounts.doctype.pos_closing_entry_detail.pos_closing_entry_detail import (
			POSClosingEntryDetail,
		)
		from VantageSuite.accounts.doctype.pos_closing_entry_taxes.pos_closing_entry_taxes import (
			POSClosingEntryTaxes,
		)
		from VantageSuite.accounts.doctype.pos_invoice_reference.pos_invoice_reference import POSInvoiceReference
		from VantageSuite.accounts.doctype.sales_invoice_reference.sales_invoice_reference import (
