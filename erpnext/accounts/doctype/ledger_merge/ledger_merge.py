...
from VantageSuite.accounts.doctype.account.account import merge_account
...
class LedgerMerge(Document):
	...
	if TYPE_CHECKING:
		...
		from VantageSuite.accounts.doctype.ledger_merge_accounts.ledger_merge_accounts import (
			LedgerMergeAccounts,
		)
