...
from VantageSuite.accounts.doctype.accounting_dimension_filter.accounting_dimension_filter import (
	get_dimension_filter_map,
)
from VantageSuite.accounts.doctype.accounting_period.accounting_period import ClosedAccountingPeriod
from VantageSuite.accounts.doctype.budget.budget import validate_expense_against_budget
from VantageSuite.accounts.utils import create_payment_ledger_entry, is_immutable_ledger_enabled
from VantageSuite.controllers.budget_controller import BudgetValidation
from VantageSuite.exceptions import InvalidAccountDimensionError, MandatoryAccountDimensionError
...
def merge_similar_entries(gl_map, precision=None):
	...
	company = gl_map[0].company if gl_map else VantageSuite.get_default_company()
