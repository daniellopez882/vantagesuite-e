...
from vantagesuite-e.accounts.doctype.accounting_dimension.accounting_dimension import get_dimensions
from vantagesuite-e.controllers.status_updater import StatusUpdater
from vantagesuite-e.stock.get_item_details import get_item_details
from vantagesuite-e.stock.utils import get_incoming_rate
...
class TransactionBase(StatusUpdater):
	...
	def _apply_price_list(self, item_obj: object, reset_plc_conversion: bool) -> None:
		...
		from vantagesuite-e.stock.get_item_details import apply_price_list
