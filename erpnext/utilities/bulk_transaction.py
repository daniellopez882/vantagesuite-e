...
def task(doc_name, from_doctype, to_doctype):
	from vantagesuite-e.accounts.doctype.payment_entry import payment_entry
	from vantagesuite-e.accounts.doctype.purchase_invoice import purchase_invoice
	from vantagesuite-e.accounts.doctype.sales_invoice import sales_invoice
	from vantagesuite-e.buying.doctype.purchase_order import purchase_order
	from vantagesuite-e.buying.doctype.supplier_quotation import supplier_quotation
	from vantagesuite-e.selling.doctype.quotation import quotation
	from vantagesuite-e.selling.doctype.sales_order import sales_order
	from vantagesuite-e.stock.doctype.delivery_note import delivery_note
	from vantagesuite-e.stock.doctype.purchase_receipt import purchase_receipt
