...
from vantagesuite-e.stock.doctype.bin.bin import update_qty as update_bin_qty
...
from vantagesuite-e.stock.utils import (
...
from vantagesuite-e.stock.valuation import FIFOValuation, LIFOValuation, round_off_if_near_zero
...
def make_sl_entries(sl_entries, allow_negative_stock=False, via_landed_cost_voucher=False):
	...
	args:
	        ...
	        such cases certain validations need to be ignored (like negative
	                        stock)
	"""
	from vantagesuite-e.controllers.stock_controller import future_sle_exists
...
class update_entries_after:
	...
	def get_serialized_values(self, sle):
		from vantagesuite-e.stock.serial_batch_bundle import SerialNoValuation
	...
	def update_serial_no_status(self, sle):
		from vantagesuite-e.stock.serial_batch_bundle import get_serial_nos
	...
	def update_serial_batch_no_valuation(self, sle, doc, prev_sle=None):
		from vantagesuite-e.stock.serial_batch_bundle import BatchNoValuation, SerialNoValuation
	...
	def get_incoming_outgoing_rate_from_transaction(self, sle):
		...
		# Sales and Purchase Return
			...
			if frappe.get_cached_value(sle.voucher_type, sle.voucher_no, "is_return"):
				from vantagesuite-e.controllers.sales_and_purchase_return import (
	...
	def update_batched_values(self, sle):
		from vantagesuite-e.stock.serial_batch_bundle import BatchNoValuation
	...
	def get_fallback_rate(self, sle) -> float:
		...
		return get_valuation_rate(
			...
			currency=vantagesuite-e.get_company_currency(sle.company),
			company=sle.company,
		)
...
def get_valuation_rate(
	...
	if (
		...
		and cint(vantagesuite-e.is_perpetual_inventory_enabled(company))
	):
