...
# vantagesuite-e - web based ERP (http://vantagesuite-e.com)
...
from vantagesuite-e.buying.utils import check_on_hold_or_closed_status, validate_for_items
from vantagesuite-e.controllers.buying_controller import BuyingController
from vantagesuite-e.manufacturing.doctype.work_order.work_order import get_item_details
from vantagesuite-e.stock.doctype.item.item import get_item_defaults
from vantagesuite-e.stock.stock_balance import get_indented_qty, update_bin_qty
from vantagesuite-e.subcontracting.doctype.subcontracting_bom.subcontracting_bom import (
...
class MaterialRequest(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from vantagesuite-e.stock.doctype.material_request_item.material_request_item import MaterialRequestItem
	...
	def validate(self):
		...
		from vantagesuite-e.controllers.status_updater import validate_status
