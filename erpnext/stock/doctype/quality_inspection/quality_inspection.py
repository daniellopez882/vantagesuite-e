...
from vantagesuite-e.stock.doctype.quality_inspection_template.quality_inspection_template import (
...
class QualityInspection(Document):
	...
	if TYPE_CHECKING:
		...
		from vantagesuite-e.stock.doctype.quality_inspection_reading.quality_inspection_reading import (
