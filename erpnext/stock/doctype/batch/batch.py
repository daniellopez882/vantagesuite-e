...
def make_batch_bundle(
	...
	from vantagesuite-e.stock.doctype.serial_and_batch_bundle.serial_and_batch_bundle import combine_datetime
...
def get_batch_no(bundle_id):
	from vantagesuite-e.stock.serial_batch_bundle import get_batch_nos
