...
from vantagesuite-e.accounts.party import get_party_shipping_address
...
class Shipment(Document):
	...
	if TYPE_CHECKING:
		...
		from vantagesuite-e.stock.doctype.shipment_delivery_note.shipment_delivery_note import (
			ShipmentDeliveryNote,
		)
		from vantagesuite-e.stock.doctype.shipment_parcel.shipment_parcel import ShipmentParcel
