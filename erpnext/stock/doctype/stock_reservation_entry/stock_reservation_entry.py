...
from vantagesuite-e.stock.utils import get_or_make_bin, get_stock_balance
...
class StockReservationEntry(Document):
	...
	if TYPE_CHECKING:
		...
		from vantagesuite-e.stock.doctype.serial_and_batch_entry.serial_and_batch_entry import SerialandBatchEntry
	...
	def validate(self) -> None:
		from vantagesuite-e.stock.utils import validate_disabled_warehouse, validate_warehouse_company
	...
	def auto_reserve_serial_and_batch(self, based_on: str | None = None) -> None:
		...
		if (
			...
			from vantagesuite-e.stock.serial_batch_bundle import get_serial_nos_batch
...
def create_stock_reservation_entries_for_so_items(
	...
	from vantagesuite-e.selling.doctype.sales_order.sales_order import get_unreserved_qty
