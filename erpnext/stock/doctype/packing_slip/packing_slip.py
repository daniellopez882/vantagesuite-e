...
class PackingSlip(StatusUpdater):
	...
	if TYPE_CHECKING:
		...
		from vantagesuite-e.stock.doctype.packing_slip_item.packing_slip_item import PackingSlipItem
	...
	def validate(self) -> None:
		from vantagesuite-e.utilities.transaction_base import validate_uom_is_integer
...
def item_details(doctype, txt, searchfield, start, page_len, filters):
	from vantagesuite-e.controllers.queries import get_match_cond
