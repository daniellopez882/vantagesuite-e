...
class Bin(Document):
	...
	def recalculate_qty(self):
		from vantagesuite-e.manufacturing.doctype.work_order.work_order import get_reserved_qty_for_production
		from vantagesuite-e.stock.stock_balance import (
			get_indented_qty,
			get_ordered_qty,
			get_planned_qty,
			get_reserved_qty,
	...
	def update_reserved_qty_for_production_plan(self, skip_project_qty_update=False, update_qty=True):
		...
		from vantagesuite-e.manufacturing.doctype.production_plan.production_plan import (
