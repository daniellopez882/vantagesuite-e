...
vantagesuite-e.landed_cost_taxes_and_charges.setup_triggers("Landed Cost Voucher");
vantagesuite-e.stock.LandedCostVoucher = class LandedCostVoucher extends vantagesuite-e.stock.StockController {
	refresh() {
...
cur_frm.script_manager.make(vantagesuite-e.stock.LandedCostVoucher);
...
frappe.ui.form.on("Landed Cost Voucher", {
	...
	setup_queries(frm) {
		...
		frm.set_query("vendor_invoice", "vendor_invoices", (doc, cdt, cdn) => {
			return {
				query: "vantagesuite-e.stock.doctype.landed_cost_voucher.landed_cost_voucher.get_vendor_invoices",
				filters: {
					company: doc.company,
				},
			};
