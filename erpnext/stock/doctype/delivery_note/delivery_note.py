...
from vantagesuite-e.accounts.party import get_due_date
from vantagesuite-e.controllers.accounts_controller import get_taxes_and_charges, merge_taxes
from vantagesuite-e.controllers.selling_controller import SellingController
...
class DeliveryNote(SellingController):
	...
	if TYPE_CHECKING:
		...
		from vantagesuite-e.accounts.doctype.sales_taxes_and_charges.sales_taxes_and_charges import (
			SalesTaxesandCharges,
		)
		from vantagesuite-e.selling.doctype.sales_team.sales_team import SalesTeam
		from vantagesuite-e.stock.doctype.delivery_note_item.delivery_note_item import DeliveryNoteItem
		from vantagesuite-e.stock.doctype.packed_item.packed_item import PackedItem
	...
	def validate(self):
		...
		from vantagesuite-e.stock.doctype.packed_item.packed_item import make_packing_list
	...
	def validate_against_stock_reservation_entries(self):
		...
		from vantagesuite-e.stock.doctype.stock_reservation_entry.stock_reservation_entry import (
	...
	def check_credit_limit(self):
		from vantagesuite-e.selling.doctype.customer.customer import check_credit_limit
...
def get_list_context(context=None):
	from vantagesuite-e.controllers.website_list_for_contact import get_list_context
...
def make_inter_company_transaction(doctype, source_name, target_doc=None):
	from vantagesuite-e.accounts.doctype.sales_invoice.sales_invoice import (
