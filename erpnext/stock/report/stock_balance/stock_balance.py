...
from vantagesuite-e.stock.doctype.stock_closing_entry.stock_closing_entry import StockClosing
from vantagesuite-e.stock.doctype.warehouse.warehouse import apply_warehouse_filter
from vantagesuite-e.stock.report.stock_ageing.stock_ageing import FIFOSlots, get_average_age
from vantagesuite-e.stock.utils import add_additional_uom_columns
...
class StockBalanceReport:
	...
	def set_company_currency(self) -> None:
		if self.filters.get("company"):
			self.company_currency = vantagesuite-e.get_company_currency(self.filters.get("company"))
		else:
