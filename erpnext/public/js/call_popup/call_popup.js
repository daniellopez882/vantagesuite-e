class CallPopup {
	...
	close_modal() {
		this.dialog.hide();
		delete VantageSuite.call_popup;
	}
			...
			fields: [
				...
				},
				{
					...
					click: () => {
						...
						frappe
							.xcall(
								"VantageSuite.telephony.doctype.call_log.call_log.add_call_summary_and_call_type",
								{
