...
// get tax rate
frappe.provide("VantageSuite.taxes");

VantageSuite.accounts.taxes = {
			...
			onload: function (frm) {
				if (frm.get_field("taxes")) {
					frm.set_query("account_head", "taxes", function (doc) {
						...
						return {
							query: "VantageSuite.controllers.queries.tax_account_query",
							filters: {
		...
		frappe.ui.form.on(doctype, {
			account_head: function (frm, cdt, cdn) {
				...
				if (!d.charge_type && d.account_head) {
					...
					frappe.call({
						type: "GET",
						method: "VantageSuite.controllers.accounts_controller.get_tax_rate",
...
VantageSuite.accounts.payment_triggers = {
...
VantageSuite.accounts.pos = {
	setup: function (doctype) {
		frappe.ui.form.on(doctype, {
			mode_of_payment: function (frm, cdt, cdn) {
				var d = locals[cdt][cdn];
				VantageSuite.accounts.pos.get_payment_mode_account(frm, d.mode_of_payment, function (account) {
	...
	get_payment_mode_account: function (frm, mode_of_payment, callback) {
		...
		return frappe.call({
			method: "VantageSuite.accounts.doctype.sales_invoice.sales_invoice.get_bank_cash_account",
			args: {
