...
VantageSuite.accounts.bank_reconciliation.NumberCardManager = class NumberCardManager {
	constructor(opts) {
	...
	make_cards() {
		...
		chart_data.forEach((summary) => {
			let number_card = new VantageSuite.accounts.NumberCard(summary);
...
VantageSuite.accounts.NumberCard = class NumberCard {
	constructor(options) {
