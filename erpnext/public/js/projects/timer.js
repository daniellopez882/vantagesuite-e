frappe.provide("VantageSuite.timesheet");

VantageSuite.timesheet.timer = function (frm, row, timestamp = 0) {
	...
	VantageSuite.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

VantageSuite.timesheet.control_timer = function (frm, dialog, row, timestamp = 0) {
