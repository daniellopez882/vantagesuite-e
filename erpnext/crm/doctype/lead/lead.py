...
from VantageSuite.accounts.party import set_taxes
from VantageSuite.controllers.selling_controller import SellingController
from VantageSuite.crm.utils import CRMNote, copy_comments, link_communications, link_open_events
from VantageSuite.selling.doctype.customer.customer import parse_full_name
...
def get_lead_details(lead, posting_date=None, company=None, doctype=None):
	...
	from VantageSuite.accounts.party import set_address_details
