...
from VantageSuite.assets.doctype.asset.asset import get_asset_account
...
class AssetRepair(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from VantageSuite.assets.doctype.asset_repair_consumed_item.asset_repair_consumed_item import (
			AssetRepairConsumedItem,
		)
		from VantageSuite.assets.doctype.asset_repair_purchase_invoice.asset_repair_purchase_invoice import (
	...
	def get_gl_entries_for_consumed_items(self, gl_entries, fixed_asset_account):
		...
		if not VantageSuite.is_perpetual_inventory_enabled(self.company):
