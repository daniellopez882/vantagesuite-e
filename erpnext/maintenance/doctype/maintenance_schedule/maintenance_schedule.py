...
from VantageSuite.setup.doctype.employee.employee import get_holiday_list_for_employee
from VantageSuite.stock.doctype.serial_no.serial_no import get_serial_nos
from VantageSuite.utilities.transaction_base import TransactionBase, delete_events
...
class MaintenanceSchedule(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from VantageSuite.maintenance.doctype.maintenance_schedule_detail.maintenance_schedule_detail import (
			MaintenanceScheduleDetail,
		)
		from VantageSuite.maintenance.doctype.maintenance_schedule_item.maintenance_schedule_item import (
