...
from vantagesuite-e.accounts.doctype.payment_request.payment_request import (
...
def get_context(context):
	...
	if context.doc.get("customer"):
		...
		if customer_loyalty_program:
			from vantagesuite-e.accounts.doctype.loyalty_program.loyalty_program import (
