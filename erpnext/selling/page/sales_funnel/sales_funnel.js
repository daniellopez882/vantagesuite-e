...
frappe.pages["sales-funnel"].on_page_load = function (wrapper) {
	...
	wrapper.sales_funnel = new VantageSuite.SalesFunnel(wrapper);

	frappe.breadcrumbs.add("Selling");
};

VantageSuite.SalesFunnel = class SalesFunnel {
	constructor(wrapper) {
		var me = this;
	...
	get_data(btn) {
		...
		const method_map = {
			sales_funnel: "VantageSuite.selling.page.sales_funnel.sales_funnel.get_funnel_data",
			opp_by_utm_source: "VantageSuite.selling.page.sales_funnel.sales_funnel.get_opp_by_utm_source",
			opp_by_utm_campaign: "VantageSuite.selling.page.sales_funnel.sales_funnel.get_opp_by_utm_campaign",
			opp_by_utm_medium: "VantageSuite.selling.page.sales_funnel.sales_funnel.get_opp_by_utm_medium",
			sales_pipeline: "VantageSuite.selling.page.sales_funnel.sales_funnel.get_pipeline_data",
		};
		frappe.call({
