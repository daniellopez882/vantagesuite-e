...
from VantageSuite.accounts.party import get_party_account
from VantageSuite.controllers.selling_controller import SellingController
from VantageSuite.manufacturing.doctype.blanket_order.blanket_order import (
	validate_against_blanket_order,
)
from VantageSuite.manufacturing.doctype.production_plan.production_plan import (
	get_items_for_material_requests,
)
from VantageSuite.selling.doctype.customer.customer import check_credit_limit
from VantageSuite.setup.doctype.item_group.item_group import get_item_group_defaults
from VantageSuite.stock.doctype.item.item import get_item_defaults
...
from VantageSuite.stock.stock_balance import get_reserved_qty, update_bin_qty
...
class SalesOrder(SellingController):
	...
	if TYPE_CHECKING:
		...
		from VantageSuite.selling.doctype.sales_order_item.sales_order_item import SalesOrderItem
	...
	def validate(self):
		...
		if self.coupon_code:
			from VantageSuite.accounts.doctype.pricing_rule.utils import validate_coupon_code
	...
	def on_submit(self):
		...
		if self.coupon_code:
			from VantageSuite.accounts.doctype.pricing_rule.utils import update_coupon_code_count
	...
	def update_subcontracting_order_status(self):
		from VantageSuite.subcontracting.doctype.subcontracting_inward_order.subcontracting_inward_order import (
...
def create_pick_list(source_name, target_doc=None):
	from VantageSuite.stock.doctype.packed_item.packed_item import is_product_bundle
