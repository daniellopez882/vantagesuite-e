...
from vantagesuite-e import get_default_company
...
def welcome_email():
	site_name = get_default_company() or "vantagesuite-e"
...
def identity(x, *args, **kwargs):
	...
	Use like this: `from vantagesuite-e.setup.utils import identity as _`
	"""
	return x
