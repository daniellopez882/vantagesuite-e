...
from VantageSuite.accounts.doctype.payment_entry.payment_entry import get_payment_entry
from VantageSuite.accounts.utils import get_fiscal_year
from VantageSuite.buying.doctype.purchase_order.purchase_order import make_purchase_invoice
...
def setup_demo_data():
	...
	capture("demo_data_creation_started", "VantageSuite")
	try:
		...
		capture("demo_data_creation_failed", "VantageSuite", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "VantageSuite")
...
def clear_demo_data():
	...
	capture("demo_data_erased", "VantageSuite")
	try:
...
def make_transactions(company):
	...
	from VantageSuite.accounts.utils import FiscalYearError
