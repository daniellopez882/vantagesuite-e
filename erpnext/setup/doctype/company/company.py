...
from vantagesuite-e.accounts.doctype.account.account import get_account_currency
from vantagesuite-e.accounts.doctype.financial_report_template.financial_report_template import (
	sync_financial_report_templates,
)
from vantagesuite-e.setup.setup_wizard.operations.taxes_setup import setup_taxes_and_charges
from vantagesuite-e.stock.utils import check_pending_reposting
...
class Company(NestedSet):
	...
	def create_default_accounts(self):
		from vantagesuite-e.accounts.doctype.account.chart_of_accounts.chart_of_accounts import create_charts
...
def install_country_fixtures(company, country):
	try:
		module_name = f"vantagesuite-e.regional.{frappe.scrub(country)}.setup.setup"
...
def create_transaction_deletion_request(company):
	from VantageSuite.setup.doctype.transaction_deletion_record.transaction_deletion_record import (
