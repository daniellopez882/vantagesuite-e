...
class CustomerGroup(NestedSet):
	...
	if TYPE_CHECKING:
		...
		from vantagesuite-e.accounts.doctype.party_account.party_account import PartyAccount
		from vantagesuite-e.selling.doctype.customer_credit_limit.customer_credit_limit import CustomerCreditLimit
