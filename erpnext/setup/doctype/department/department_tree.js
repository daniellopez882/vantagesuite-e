frappe.treeview_settings["Department"] = {
	...
	get_tree_nodes: "vantagesuite-e.setup.doctype.department.department.get_children",
	add_tree_node: "vantagesuite-e.setup.doctype.department.department.add_node",
	filters: [
		{
			fieldname: "company",
			fieldtype: "Link",
