...
from vantagesuite-e.setup.doctype.incoterm.incoterm import create_incoterms
from vantagesuite-e.setup.utils import identity as _

from .default_success_action import get_default_success_action

default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="http://frappe.io/vantagesuite-e">vantagesuite-e</a></div>"""
...
def create_custom_company_links():
	...
	with a company in vantagesuite-e to allow for multitenancy. I.e. one company should
...
def add_standard_navbar_items():
	...
	vantagesuite-e_navbar_items = [
		...
		},
		{
			...
			"item_type": "Route",
			"route": "https://github.com/frappe/vantagesuite-e/issues",
			"is_standard": 1,
		},
	]
	...
	for item in vantagesuite-e_navbar_items:
...
def add_app_name():
	frappe.db.set_single_value("System Settings", "app_name", "vantagesuite-e")
...
def create_letter_head():
	base_path = frappe.get_app_path("vantagesuite-e", "accounts", "letterhead")
