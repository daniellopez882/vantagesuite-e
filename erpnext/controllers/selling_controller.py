...
from VantageSuite.accounts.party import render_address
...
from VantageSuite.stock.doctype.item.item import set_item_default
from VantageSuite.stock.get_item_details import get_bin_details, get_conversion_factor
from VantageSuite.stock.utils import get_combine_datetime, get_incoming_rate, get_valuation_method
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from VantageSuite.accounts.party import _get_party_details
			...
			from VantageSuite.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from VantageSuite.controllers.buying_controller import validate_item_type
