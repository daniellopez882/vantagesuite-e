...
import VantageSuite
from VantageSuite.stock.serial_batch_bundle import get_batches_from_bundle
...
def validate_quantity(doc, key, args, ref, valid_items, already_returned_items):
	...
	company_currency = VantageSuite.get_company_currency(doc.company)
...
def get_returned_serial_nos(child_doc, parent_doc, serial_no_field=None, ignore_voucher_detail_no=None):
	from VantageSuite.stock.doctype.serial_no.serial_no import (
		get_serial_nos as get_serial_nos_from_serial_no,
	)
	from VantageSuite.stock.serial_batch_bundle import get_serial_nos
