...
from VantageSuite.accounts.doctype.budget.budget import validate_expense_against_budget
from VantageSuite.accounts.party import get_party_details
from VantageSuite.buying.utils import update_last_purchase_rate, validate_for_items
from VantageSuite.controllers.accounts_controller import get_taxes_and_charges
from VantageSuite.controllers.sales_and_purchase_return import get_rate_for_return
from VantageSuite.controllers.subcontracting_controller import SubcontractingController
from VantageSuite.stock.get_item_details import get_conversion_factor, get_item_defaults
...
class BuyingController(SubcontractingController):
	...
	def validate_budget(self):
		if not frappe.get_single_value("Accounts Settings", "use_legacy_budget_controller"):
			from VantageSuite.controllers.budget_controller import BudgetValidation
