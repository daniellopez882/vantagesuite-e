...
from VantageSuite.accounts.utils import cancel_exchange_gain_loss_journal, get_fiscal_year
from VantageSuite.controllers.accounts_controller import AccountsController
from VantageSuite.controllers.sales_and_purchase_return import (
	available_serial_batch_for_return,
	filter_serial_batches,
	make_serial_batch_bundle_for_return,
)
from VantageSuite.setup.doctype.brand.brand import get_brand_defaults
from VantageSuite.setup.doctype.item_group.item_group import get_item_group_defaults
from VantageSuite.stock import get_warehouse_account_map
from VantageSuite.stock.doctype.batch.batch import get_batch_qty
from VantageSuite.stock.doctype.inventory_dimension.inventory_dimension import (
	get_evaluated_inventory_dimension,
)
from VantageSuite.stock.doctype.item.item import get_item_defaults
from VantageSuite.stock.doctype.serial_and_batch_bundle.serial_and_batch_bundle import (
	combine_datetime,
	get_type_of_transaction,
)
from VantageSuite.stock.stock_ledger import get_items_to_be_repost
...
class StockController(AccountsController):
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False, via_landed_cost_voucher=False):
		...
		if (
			cint(VantageSuite.is_perpetual_inventory_enabled(self.company))
	...
	def clean_serial_nos(self):
		from VantageSuite.stock.doctype.serial_no.serial_no import clean_serial_no_string
	...
	def create_serial_batch_bundle(self, bundle_details, row):
		from VantageSuite.stock.serial_batch_bundle import SerialBatchCreation
	...
	def get_sl_entries(self, d, args):
		...
		if self.docstatus == 2:
			from VantageSuite.deprecation_dumpster import deprecation_warning
	...
	def make_sl_entries(self, sl_entries, allow_negative_stock=False, via_landed_cost_voucher=False):
		from VantageSuite.stock.serial_batch_bundle import update_batch_qty
		from VantageSuite.stock.stock_ledger import make_sl_entries
	...
	def validate_warehouse(self):
		from VantageSuite.stock.utils import validate_disabled_warehouse, validate_warehouse_company
	...
	def validate_putaway_capacity(self):
		...
		from VantageSuite.stock.doctype.putaway_rule.putaway_rule import get_available_putaway_capacity
...
def get_accounting_ledger_preview(doc, filters):
	from VantageSuite.accounts.report.general_ledger.general_ledger import get_columns as get_gl_columns
...
def get_stock_ledger_preview(doc, filters):
	from VantageSuite.stock.report.stock_ledger.stock_ledger import get_columns as get_sl_columns
...
def future_sle_exists(args, sl_entries=None):
	from VantageSuite.stock.utils import get_combine_datetime
